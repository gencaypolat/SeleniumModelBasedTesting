...
public class addToWishListTest extends ExecutionContext implements addToWishList {
    ...
    public void e_addToWishList() {
        WebElement addToWishlistButton = driver.findElement(By.xpath("//button[@data-original-title='Add to Wish List']"));
        addToWishlistButton.click();
        //driver.findElement(By.cssSelector(".product-layout:nth-child(2) .fa-heart")).click();
        driver.findElement(By.cssSelector("#wishlist-total > .fa")).click();
    }
    @Override
    public void v_wishList() {
        String actualTitle = driver.getTitle();
        String expectedTitle = "My Wish List";
        testTitle(expectedTitle, actualTitle);
    }
    @Override
